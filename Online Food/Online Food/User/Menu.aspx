<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Online_Food.User.Menu" %>
        ...
        <div class="container">
            ...
            <ul class="filters_menu">
                ...
                <asp:Repeater ID="rCategory" runat="server">
                    <ItemTemplate>
                        <li data-filter=".<%# HttpUtility.HtmlEncode(Eval("CategoryName").ToString().ToLower()) %> "><%# Eval("CategoryName") %></li>
