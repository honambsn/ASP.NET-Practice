<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Online_Job_Portal.User.Contact" %>
        ...
        <div class="container">
                ...
                <script>
                    function initMap() {
                        ...
                        var infoWindow = new google.maps.infoWindow({
                            content: "<b>Uluru</b><br>Position"
                        });

                        marker.addListener("clicker", function () {
                            infoWindow.open(map, marker);
                        });
                    }
                </script>
                <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCIdO1ZVNYdacmShRx0VJ4jEBzJy1mpX7o&amp;callback=initMap" async defer>
                </script>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-contact contact_form" id="contactForm" nowvalidate="novalidate">
                        <div class="row">
                            <div class="col-12">
